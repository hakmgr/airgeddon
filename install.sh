...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202210291109-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.com
# @@License          :  WTFPL
# @@ReadME           :  install.sh --help
# @@Copyright        :  Copyright: (c) 2022 Jason Hempstead, Casjays Developments
# @@Created          :  Saturday, Oct 29, 2022 11:09 EDT
# @@File             :  install.sh
# @@Description      :
...
SCRIPTSFUNCTFILE="${SCRIPTSAPPFUNCTFILE:-hakmgr.func.bash}"
SCRIPTSFUNCTURL="${SCRIPTSAPPFUNCTURL:-https://github.com/casjay-dotfiles/scripts/installer/raw/main/functions}"
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Global packages
APP="iw aircrack-ng xterm pciutils crunch mdk4 hashcat hostapd lighttpd nftables bettercap "
APP+="hcxdumptool ettercap dnsmasq reaver bully pixiewps asleap openssl hcxtools "
if_os_id arch && APP+="iproute2 procps-ng wireshark-cli "
if_os_id centos && APP+="iproute procps wireshark-cli "
if_os_id debian && APP+="iproute2 procps tshark "
#
PERL=""
PYTH=""
PIPS=""
